 ...
 * @version $Id: login.jsp 459 2009-07-20 02:07:28Z cobracoderyu@gmail.com $
 *
...
Ext.extend(Ext.ux.LoginWindow, Ext.util.Observable, {
    ...
    setlanguage : function() {
        ...
        if (this.defaultLanguage == 'zh_CN') {
            ...
            var un = Ext.getCmp(this.usernameId);
            un.setFieldLabel('用户名:');
            un.blankText = '该输入项为必输项';
            un.vtypeText = '该输入项只能包含字符,数字和_';
            Ext.getCmp(this.passwordId).setFieldLabel('密码:');
            Ext.getCmp(this.passwordId).blankText = '该输入项为必输项';
            Ext.getCmp(this.passwordId).vtypeText = '该输入项只能包含字符,数字和_';
            ...
            Ext.getCmp(this._resetButtonId).setText('Clear');
             var un = Ext.getCmp(this.usernameId);
            un.setFieldLabel('Username:');
            un.blankText = 'This field is required';
            un.vtypeText = 'This field should only contain letters, numbers and _';
            Ext.getCmp(this.passwordId).setFieldLabel('Password:');
            Ext.getCmp(this.passwordId).blankText = 'This field is required';
            Ext.getCmp(this.passwordId).vtypeText = 'This field should only contain letters, numbers and _';

...
public class FilterSecurityInterceptor extends AbstractSecurityInterceptor implements Filter, Ordered {
	...
	static Logger log=Logger.getLogger(FilterSecurityInterceptor.class);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    	...
    	Enumeration<String> em = re.getParameterNames();
    	log.debug("-------------------");
    	log.debug(re.getServletPath());
//    	log.debug(re.getPathInfo());
//    	log.debug(re.getRequestURI());

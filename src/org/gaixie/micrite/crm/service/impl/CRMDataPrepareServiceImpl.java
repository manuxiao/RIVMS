/* ===========================================================
 * $Id: CRMDataPrepareServiceImpl.java 520 2009-08-27 05:59:23Z bitorb $
...
//    @Autowired
//    private ICarownerDAO customerSourceDAO;

    @Autowired
    private ICarownerDAO carownerDAO;
    
    public void initDataForRun() {
//        if(customerDAO.get(1)!=null) return;
...
//        customerSourceDAO.save(cs);
//        
//        Customer customer = new Customer(new Date(),"Bob Yu","139000000",new Date(),cs);

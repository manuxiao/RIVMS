/* ===========================================================
 * $Id: ICustomerDAO.java 516 2009-08-23 16:33:31Z bitorb $
 ...
 * 客户管理持久化接口
 */
public interface ICustomerDAO extends IGenericDAO<Carowner, Integer> {
...
//    public List<CustomerSource> findAllCustomerSource();
     ...
     * @return
     */
    public List<Carowner> findByCreateDateSpacingPerPage(Date startDate,Date endDate, int start, int limit,int customerSourceType);
    /**
     * 高级查询并按用户来源进行分组
     * @param telphone
     * @return 分组数据集合

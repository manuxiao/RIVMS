package org.gaixie.micrite.river.service;
...
//	public final static int ENTPRISE_EVENT_DIED = 6;
   ...
   /**
 * 删除企业
 * @param RiverIds 企业的id数组
 */
public void delete(int[] RiverIds);
    
    /**
     * 日期间隔及RiverSourceType普通查询企业总记录数
     * @param createDate
     * @return
     */
    public int findByCreateDateSpacingCount(Date startDate,Date endDate,int villageId);
    /**
     * 日期间隔查及RiverSourceType普通询企业 
     * @param createDate
     * @param start
     * @param limit
     * @return
     */
    public List<River> findByCreateDateSpacingPerPage(Date startDate,Date endDate, int start, int limit,int villageId);
    /**
     * 高级查询获取用户来源的2D柱图对象
